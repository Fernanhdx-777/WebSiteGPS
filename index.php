            ...
            <div class="col-12 col-md-10 col-lg-8">
                ...
                <div id="carouselExampleIndicators" class="carousel slide carousel-custom" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <!-- Añadida la clase w-100 para asegurar que la imagen ocupe el contenedor -->
        ...
        <div class="row g-5 align-items-stretch">
            ...
            <div class="col-12 col-md-6 d-flex flex-column justify-content-between">
                <div>
                    ...
                    <p class="text-muted mb-4">Estamos listos para atenderte y optimizar tus labores en el campo.</p>
                    ...
                    <form id="form" action="" method="post" class="needs-validation" novalidate>
                        ...
                        <div class="text-start mt-3">
                            <p class="text-muted small mb-0">
                                <span class="text-danger fw-bold">*</span> Los campos marcados son obligatorios.
                            </p>
                        </div>
                    </form>
                </div>
